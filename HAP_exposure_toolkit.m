...
%{
GPS_master1 - format found in 'example data'
GPS_master2 - format found in 'example data'
GPS_master4REX - format found in 'example data'
GPS_master3REX - format found in 'example data'
HH_data - format found in 'example data'
User_data - format found in 'example data'
PC_model
compliance_ensemble_BALogger (v2, v3)
compliance_ensemble_PhoneLogger (v2, v3)
%}
